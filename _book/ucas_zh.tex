...
或\texttt{{[}@R-base{]}}来引用它，后者将会在括号中引用文献，如(R Core Team \protect\hyperlink{ref-R-base}{2016})。

同时在\texttt{knitr}中还有一个辅助函数\texttt{knitr::write\_bib()}可以帮助你引用在写论文时使用到的包。例如：

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{write_bib}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"knitr"}\NormalTok{, }\StringTok{"stringr"}\NormalTok{), }\StringTok{"Rpackage.bib"}\NormalTok{, }\DataTypeTok{width =} \DecValTok{60}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\chapter{作者简历及攻读学位期间发表的学术论文与研究成果}\label{section-8}}

本科生无需此部分。

\hypertarget{section-9}{%
\chapter{致谢}\label{section-9}}
...
\chapter{中南财经政法大学本科生毕业论文规范}\label{section-10}}
...
\section{毕业论文（设计）内容及要求}\label{section-11}}
...
\subsection{封面}\label{section-12}}
...
\subsection{作者声明}\label{section-13}}
...
\subsection{论文（设计）题目及署名}\label{section-14}}
...
\subsection{中外（英）文摘要及关键词}\label{section-15}}

\hypertarget{section-16}{%
\subsubsection{中文摘要及关键词}\label{section-16}}
...
\subsubsection{外（英）文摘要与关键词}\label{section-17}}
...
\subsection{目录}\label{section-18}}
...
\subsection{正文}\label{section-19}}
...
\subsection{注释}\label{section-20}}
...
\subsection{主要参考文献}\label{section-21}}
...
\subsection{附录（非必选项）}\label{section-22}}
...
\subsection{后记（非必选项）}\label{section-23}}
...
\section{毕业论文（设计）撰写规范}\label{section-24}}

\hypertarget{section-25}{%
\subsection{行文}\label{section-25}}
...
\subsection{正文主体}\label{section-26}}
...
\subsection{表格}\label{section-27}}
...
\subsection{插图}\label{section-28}}
...
\subsection{公式}\label{section-29}}
...
\subsection{数字}\label{section-30}}
...
\section{毕业论文（设计）的打印要求}\label{section-33}}
...
\section{毕业论文（设计）定稿的装订}\label{section-34}}
...
\section{毕业论文（设计）档案整理}\label{section-35}}
